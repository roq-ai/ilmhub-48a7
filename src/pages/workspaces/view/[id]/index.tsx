...
import { getWorkspaceById } from 'apiSdk/workspaces';
import { WorkspaceInterface } from 'interfaces/workspace';
import { InvitationListPage } from 'pages/invitations';
import { SectionListPage } from 'pages/sections';
import { WhiteboardListPage } from 'pages/whiteboards';
            ...
            <FormWrapper wrapperProps={{ gap: 3, p: 4 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('workspace', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/workspaces/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              <EntityImage entity="workspace" entityId={id} />
              <List
                w="100%"
                css={{
                  '> li:not(:last-child)': {
