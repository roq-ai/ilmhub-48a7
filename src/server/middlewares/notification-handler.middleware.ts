...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'information.create': {
    ...
    key: 'workspace-information-added',
    tenantPath: ['workspace', 'section', 'information'],
    userPath: [],
  },
  'information.update': {
    roles: ['owner', 'team-member'],
    key: 'workspace-information-updated',
    tenantPath: ['workspace', 'section', 'information'],
    userPath: [],
  },
  'information.delete': {
    roles: ['owner', 'team-member'],
    key: 'workspace-information-deleted',
    tenantPath: ['workspace', 'section', 'information'],
    userPath: [],
  },
};
...
export async function notificationHandlerMiddleware(req: NextApiRequest, entityId: string) {
  ...
  const tenant = await prisma.workspace.findFirst({
